...
public class ModelCICIS4FrontSightFlipped extends ModelAttachment //Same as Filename
{
	int textureX = 64;
	int textureY = 64;
	...
	public ModelCICIS4FrontSightFlipped() //Same as Filename
	{
		...
		attachmentModel[14].rotateAngleZ = -2.35619449F;
