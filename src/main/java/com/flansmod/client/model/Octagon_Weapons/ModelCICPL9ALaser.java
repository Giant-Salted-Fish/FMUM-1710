...
public class ModelCICPL9ALaser extends ModelDefault //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelCICPL9ALaser() //Same as Filename
	{
		defaultModel = new ModelRendererTurbo[20];
		defaultModel[0] = new ModelRendererTurbo(this, 123, 123, textureX, textureY); // Box 572
		defaultModel[1] = new ModelRendererTurbo(this, 123, 123, textureX, textureY); // Box 574
		defaultModel[2] = new ModelRendererTurbo(this, 123, 123, textureX, textureY); // Box 575
		defaultModel[3] = new ModelRendererTurbo(this, 123, 123, textureX, textureY); // Box 576
		defaultModel[4] = new ModelRendererTurbo(this, 123, 123, textureX, textureY); // Box 577
		defaultModel[5] = new ModelRendererTurbo(this, 121, 123, textureX, textureY); // Box 578
		defaultModel[6] = new ModelRendererTurbo(this, 121, 123, textureX, textureY); // Box 579
		defaultModel[7] = new ModelRendererTurbo(this, 121, 123, textureX, textureY); // Box 580
		defaultModel[8] = new ModelRendererTurbo(this, 121, 123, textureX, textureY); // Box 581
		defaultModel[9] = new ModelRendererTurbo(this, 121, 123, textureX, textureY); // Box 582
		defaultModel[10] = new ModelRendererTurbo(this, 121, 125, textureX, textureY); // Box 10
		defaultModel[11] = new ModelRendererTurbo(this, 123, 125, textureX, textureY); // Box 11
		defaultModel[12] = new ModelRendererTurbo(this, 121, 125, textureX, textureY); // Box 12
		defaultModel[13] = new ModelRendererTurbo(this, 123, 125, textureX, textureY); // Box 13
		defaultModel[14] = new ModelRendererTurbo(this, 121, 125, textureX, textureY); // Box 14
		defaultModel[15] = new ModelRendererTurbo(this, 123, 125, textureX, textureY); // Box 15
		defaultModel[16] = new ModelRendererTurbo(this, 123, 125, textureX, textureY); // Box 16
		defaultModel[17] = new ModelRendererTurbo(this, 121, 125, textureX, textureY); // Box 17
		defaultModel[18] = new ModelRendererTurbo(this, 123, 125, textureX, textureY); // Box 18
		defaultModel[19] = new ModelRendererTurbo(this, 121, 125, textureX, textureY); // Box 19
		...
		defaultModel[14].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 14
		defaultModel[14].setRotationPoint(148F, 0F, -1F);

		defaultModel[15].addShapeBox(0F, 0F, 0F, 1, 2, 0, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 15
		defaultModel[15].setRotationPoint(148F, -1F, 0F);

		defaultModel[16].addShapeBox(0F, 0F, 0F, 1, 2, 0, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F); // Box 16
		defaultModel[16].setRotationPoint(152F, -1F, 0F);

		defaultModel[17].addShapeBox(0F, 0F, 0F, 1, 0, 2, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, 0F, 0F, 0F); // Box 17
		defaultModel[17].setRotationPoint(152F, 0F, -1F);
