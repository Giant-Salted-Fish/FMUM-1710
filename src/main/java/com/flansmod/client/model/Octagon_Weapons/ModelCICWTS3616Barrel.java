...
public class ModelCICWTS3616Barrel extends ModelAttachment //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public ModelCICWTS3616Barrel() //Same as Filename
	{
		attachmentModel = new ModelRendererTurbo[30];
		attachmentModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 0
		attachmentModel[1] = new ModelRendererTurbo(this, 241, 1, textureX, textureY); // Box 1
		attachmentModel[2] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Box 2
		attachmentModel[3] = new ModelRendererTurbo(this, 241, 9, textureX, textureY); // Box 3
		attachmentModel[4] = new ModelRendererTurbo(this, 169, 25, textureX, textureY); // Box 53
		attachmentModel[5] = new ModelRendererTurbo(this, 193, 25, textureX, textureY); // Box 54
		attachmentModel[6] = new ModelRendererTurbo(this, 217, 25, textureX, textureY); // Box 55
		attachmentModel[7] = new ModelRendererTurbo(this, 241, 25, textureX, textureY); // Box 56
		attachmentModel[8] = new ModelRendererTurbo(this, 241, 49, textureX, textureY); // Box 127
		attachmentModel[9] = new ModelRendererTurbo(this, 281, 49, textureX, textureY); // Box 144
		attachmentModel[10] = new ModelRendererTurbo(this, 489, 33, textureX, textureY); // Box 145
		attachmentModel[11] = new ModelRendererTurbo(this, 473, 145, textureX, textureY); // Box 489
		attachmentModel[12] = new ModelRendererTurbo(this, 121, 153, textureX, textureY); // Box 490
		attachmentModel[13] = new ModelRendererTurbo(this, 145, 153, textureX, textureY); // Box 491
		attachmentModel[14] = new ModelRendererTurbo(this, 209, 153, textureX, textureY); // Box 492
		attachmentModel[15] = new ModelRendererTurbo(this, 449, 153, textureX, textureY); // Box 493
		attachmentModel[16] = new ModelRendererTurbo(this, 481, 153, textureX, textureY); // Box 494
		attachmentModel[17] = new ModelRendererTurbo(this, 361, 153, textureX, textureY); // Box 363
		attachmentModel[18] = new ModelRendererTurbo(this, 393, 161, textureX, textureY); // Box 364
		attachmentModel[19] = new ModelRendererTurbo(this, 169, 153, textureX, textureY); // Box 365
		attachmentModel[20] = new ModelRendererTurbo(this, 473, 97, textureX, textureY); // Box 367
		attachmentModel[21] = new ModelRendererTurbo(this, 473, 73, textureX, textureY); // Box 368
		attachmentModel[22] = new ModelRendererTurbo(this, 257, 97, textureX, textureY); // Box 369
		attachmentModel[23] = new ModelRendererTurbo(this, 297, 97, textureX, textureY); // Box 370
		attachmentModel[24] = new ModelRendererTurbo(this, 361, 113, textureX, textureY); // Box 371
		attachmentModel[25] = new ModelRendererTurbo(this, 161, 121, textureX, textureY); // Box 372
		attachmentModel[26] = new ModelRendererTurbo(this, 209, 121, textureX, textureY); // Box 373
		attachmentModel[27] = new ModelRendererTurbo(this, 417, 121, textureX, textureY); // Box 374
		attachmentModel[28] = new ModelRendererTurbo(this, 129, 129, textureX, textureY); // Box 375
		attachmentModel[29] = new ModelRendererTurbo(this, 57, 225, textureX, textureY); // Box 478

		attachmentModel[0].addShapeBox(0F, 0F, 0F, 117, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F); // Box 0
		attachmentModel[0].setRotationPoint(0F, -3F, -1F);

		attachmentModel[1].addShapeBox(0F, 0F, 0F, 117, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 1
		attachmentModel[1].setRotationPoint(0F, -1F, -3F);

		attachmentModel[2].addShapeBox(0F, 0F, 0F, 117, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 2
		attachmentModel[2].setRotationPoint(0F, -1F, 1F);

		attachmentModel[3].addShapeBox(0F, 0F, 0F, 117, 2, 2, 0F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 3
		...
		attachmentModel[4].setRotationPoint(117F, -2F, -1F);
		...
		attachmentModel[5].setRotationPoint(117F, 1F, -1F);
		...
		attachmentModel[6].setRotationPoint(117F, -1F, -2F);
		...
		attachmentModel[7].setRotationPoint(117F, -1F, 1F);
		...
		muzzleFlashPoint = new Vector3f(120F / 16F, 0F, 0F);
