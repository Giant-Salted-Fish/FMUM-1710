...
public class ModelFlashLightMod045DegreeRightLight extends ModelAttachment //Same as Filename
{
	int textureX = 128;
	int textureY = 128;

	public ModelFlashLightMod045DegreeRightLight() //Same as Filename
	{
