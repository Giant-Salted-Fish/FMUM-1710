...
public class ModelHK416104Barrel extends ModelAttachment //Same as Filename
{
	int textureX = 512;
	int textureY = 256;

	public ModelHK416104Barrel() //Same as Filename
	{
		attachmentModel = new ModelRendererTurbo[61];
		attachmentModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 0
		attachmentModel[1] = new ModelRendererTurbo(this, 161, 1, textureX, textureY); // Box 1
		attachmentModel[2] = new ModelRendererTurbo(this, 321, 1, textureX, textureY); // Box 2
		attachmentModel[3] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Box 7
		attachmentModel[4] = new ModelRendererTurbo(this, 481, 1, textureX, textureY); // Box 36
		attachmentModel[5] = new ModelRendererTurbo(this, 305, 9, textureX, textureY); // Box 37
		attachmentModel[6] = new ModelRendererTurbo(this, 313, 9, textureX, textureY); // Box 38
		attachmentModel[7] = new ModelRendererTurbo(this, 321, 9, textureX, textureY); // Box 39
		attachmentModel[8] = new ModelRendererTurbo(this, 457, 9, textureX, textureY); // Box 53
		attachmentModel[9] = new ModelRendererTurbo(this, 57, 25, textureX, textureY); // Box 144
		attachmentModel[10] = new ModelRendererTurbo(this, 89, 25, textureX, textureY); // Box 146
		attachmentModel[11] = new ModelRendererTurbo(this, 105, 33, textureX, textureY); // Box 147
		attachmentModel[12] = new ModelRendererTurbo(this, 297, 33, textureX, textureY); // Box 148
		attachmentModel[13] = new ModelRendererTurbo(this, 89, 41, textureX, textureY); // Box 150
		attachmentModel[14] = new ModelRendererTurbo(this, 321, 49, textureX, textureY); // Box 151
		attachmentModel[15] = new ModelRendererTurbo(this, 337, 49, textureX, textureY); // Box 152
		attachmentModel[16] = new ModelRendererTurbo(this, 449, 49, textureX, textureY); // Box 153
		attachmentModel[17] = new ModelRendererTurbo(this, 497, 89, textureX, textureY); // Box 380
		attachmentModel[18] = new ModelRendererTurbo(this, 353, 89, textureX, textureY); // Box 433
		attachmentModel[19] = new ModelRendererTurbo(this, 441, 65, textureX, textureY); // Box 434
		attachmentModel[20] = new ModelRendererTurbo(this, 465, 65, textureX, textureY); // Box 435
		attachmentModel[21] = new ModelRendererTurbo(this, 489, 65, textureX, textureY); // Box 436
		attachmentModel[22] = new ModelRendererTurbo(this, 145, 73, textureX, textureY); // Box 437
		attachmentModel[23] = new ModelRendererTurbo(this, 193, 73, textureX, textureY); // Box 539
		attachmentModel[24] = new ModelRendererTurbo(this, 153, 73, textureX, textureY); // Box 543
		attachmentModel[25] = new ModelRendererTurbo(this, 201, 73, textureX, textureY); // Box 544
		attachmentModel[26] = new ModelRendererTurbo(this, 217, 73, textureX, textureY); // Box 545
		attachmentModel[27] = new ModelRendererTurbo(this, 225, 73, textureX, textureY); // Box 546
		attachmentModel[28] = new ModelRendererTurbo(this, 209, 153, textureX, textureY); // Box 559
		attachmentModel[29] = new ModelRendererTurbo(this, 417, 153, textureX, textureY); // Box 564
		attachmentModel[30] = new ModelRendererTurbo(this, 441, 153, textureX, textureY); // Box 565
		attachmentModel[31] = new ModelRendererTurbo(this, 457, 153, textureX, textureY); // Box 566
		attachmentModel[32] = new ModelRendererTurbo(this, 473, 153, textureX, textureY); // Box 567
		attachmentModel[33] = new ModelRendererTurbo(this, 1, 161, textureX, textureY); // Box 568
		attachmentModel[34] = new ModelRendererTurbo(this, 33, 161, textureX, textureY); // Box 569
		attachmentModel[35] = new ModelRendererTurbo(this, 505, 153, textureX, textureY); // Box 570
		attachmentModel[36] = new ModelRendererTurbo(this, 65, 161, textureX, textureY); // Box 571
		attachmentModel[37] = new ModelRendererTurbo(this, 225, 153, textureX, textureY); // Box 572
		attachmentModel[38] = new ModelRendererTurbo(this, 73, 161, textureX, textureY); // Box 573
		attachmentModel[39] = new ModelRendererTurbo(this, 457, 169, textureX, textureY); // Box 632
		attachmentModel[40] = new ModelRendererTurbo(this, 281, 169, textureX, textureY); // Box 633
		attachmentModel[41] = new ModelRendererTurbo(this, 137, 177, textureX, textureY); // Box 634
		attachmentModel[42] = new ModelRendererTurbo(this, 433, 177, textureX, textureY); // Box 654
		attachmentModel[43] = new ModelRendererTurbo(this, 457, 177, textureX, textureY); // Box 655
		attachmentModel[44] = new ModelRendererTurbo(this, 481, 177, textureX, textureY); // Box 659
		attachmentModel[45] = new ModelRendererTurbo(this, 1, 185, textureX, textureY); // Box 660
		attachmentModel[46] = new ModelRendererTurbo(this, 105, 185, textureX, textureY); // Box 572
		attachmentModel[47] = new ModelRendererTurbo(this, 49, 169, textureX, textureY); // Box 573
		attachmentModel[48] = new ModelRendererTurbo(this, 137, 137, textureX, textureY); // Box 574
		attachmentModel[49] = new ModelRendererTurbo(this, 241, 145, textureX, textureY); // Box 575
		attachmentModel[50] = new ModelRendererTurbo(this, 97, 169, textureX, textureY); // Box 576
		attachmentModel[51] = new ModelRendererTurbo(this, 137, 169, textureX, textureY); // Box 577
		attachmentModel[52] = new ModelRendererTurbo(this, 297, 169, textureX, textureY); // Box 578
		attachmentModel[53] = new ModelRendererTurbo(this, 353, 145, textureX, textureY); // Box 579
		attachmentModel[54] = new ModelRendererTurbo(this, 97, 177, textureX, textureY); // Box 580
		attachmentModel[55] = new ModelRendererTurbo(this, 201, 177, textureX, textureY); // Box 581
		attachmentModel[56] = new ModelRendererTurbo(this, 401, 177, textureX, textureY); // Box 582
		attachmentModel[57] = new ModelRendererTurbo(this, 281, 121, textureX, textureY); // Box 583
		attachmentModel[58] = new ModelRendererTurbo(this, 425, 121, textureX, textureY); // Box 584
		attachmentModel[59] = new ModelRendererTurbo(this, 49, 217, textureX, textureY); // Box 607
		attachmentModel[60] = new ModelRendererTurbo(this, 65, 217, textureX, textureY); // Box 608

		attachmentModel[0].addShapeBox(0F, 0F, 0F, 75, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F); // Box 0
		attachmentModel[0].setRotationPoint(0F, -3F, -1F);

		attachmentModel[1].addShapeBox(0F, 0F, 0F, 75, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 1
		attachmentModel[1].setRotationPoint(0F, -1F, 1F);

		attachmentModel[2].addShapeBox(0F, 0F, 0F, 75, 2, 2, 0F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 2
		attachmentModel[2].setRotationPoint(0F, 1F, -1F);

		attachmentModel[3].addShapeBox(0F, 0F, 0F, 75, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 7
		...
		attachmentModel[13].setRotationPoint(75F, -2F, -1F);
		...
		attachmentModel[14].setRotationPoint(75F, 1F, -1F);
		...
		attachmentModel[15].setRotationPoint(75F, -1F, 1F);
		...
		attachmentModel[16].setRotationPoint(75F, -1F, -2F);
		...
		muzzleFlashPoint = new Vector3f(78F / 16F, 0F, 0F);
