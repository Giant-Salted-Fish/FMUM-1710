...
// Model: Osprey Silencer@5.56mm Mod 0
// Model Creator: 
...
public class ModelOspreySilencer556mmMod0 extends ModelAttachment //Same as Filename
{
	int textureX = 128;
	int textureY = 64;

	public ModelOspreySilencer556mmMod0() //Same as Filename
	{
		attachmentModel = new ModelRendererTurbo[27];
		attachmentModel[0] = new ModelRendererTurbo(this, 22, 43, textureX, textureY); // Box 211
		attachmentModel[1] = new ModelRendererTurbo(this, 32, 43, textureX, textureY); // Box 212
		attachmentModel[2] = new ModelRendererTurbo(this, 19, 47, textureX, textureY); // Box 213
		attachmentModel[3] = new ModelRendererTurbo(this, 26, 47, textureX, textureY); // Box 214
		attachmentModel[4] = new ModelRendererTurbo(this, 17, 43, textureX, textureY); // Box 218
		attachmentModel[5] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 219
		attachmentModel[6] = new ModelRendererTurbo(this, 1, 8, textureX, textureY); // Box 220
		attachmentModel[7] = new ModelRendererTurbo(this, 1, 18, textureX, textureY); // Box 221
		attachmentModel[8] = new ModelRendererTurbo(this, 1, 28, textureX, textureY); // Box 222
		attachmentModel[9] = new ModelRendererTurbo(this, 1, 35, textureX, textureY); // Box 223
		attachmentModel[10] = new ModelRendererTurbo(this, 1, 51, textureX, textureY); // Box 224
		attachmentModel[11] = new ModelRendererTurbo(this, 10, 53, textureX, textureY); // Box 225
		attachmentModel[12] = new ModelRendererTurbo(this, 30, 49, textureX, textureY); // Box 228
		attachmentModel[13] = new ModelRendererTurbo(this, 33, 43, textureX, textureY); // Box 229
		attachmentModel[14] = new ModelRendererTurbo(this, 19, 55, textureX, textureY); // Box 231
		attachmentModel[15] = new ModelRendererTurbo(this, 1, 58, textureX, textureY); // Box 232
		attachmentModel[16] = new ModelRendererTurbo(this, 42, 44, textureX, textureY); // Box 234
		attachmentModel[17] = new ModelRendererTurbo(this, 1, 43, textureX, textureY); // Box 235
		attachmentModel[18] = new ModelRendererTurbo(this, 19, 51, textureX, textureY); // Box 28
		attachmentModel[19] = new ModelRendererTurbo(this, 27, 43, textureX, textureY); // Box 29
		attachmentModel[20] = new ModelRendererTurbo(this, 12, 43, textureX, textureY); // Box 30
		attachmentModel[21] = new ModelRendererTurbo(this, 50, 49, textureX, textureY); // Box 31
		attachmentModel[22] = new ModelRendererTurbo(this, 10, 59, textureX, textureY); // Box 32
		attachmentModel[23] = new ModelRendererTurbo(this, 26, 55, textureX, textureY); // Box 33
		attachmentModel[24] = new ModelRendererTurbo(this, 12, 47, textureX, textureY); // Box 34
		attachmentModel[25] = new ModelRendererTurbo(this, 41, 49, textureX, textureY); // Box 35
		attachmentModel[26] = new ModelRendererTurbo(this, 49, 43, textureX, textureY); // Box 36
		...
		attachmentModel[5].addShapeBox(0F, 0F, 0F, 58, 3, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 2.5F, 0F, 0F, 2.5F, 0F, 0F, 2.5F, 0F, 0F, 2.5F); // Box 219
		attachmentModel[5].setRotationPoint(3F, -4F, -1.5F);

		attachmentModel[6].addShapeBox(0F, 0F, 0F, 58, 6, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 220
		attachmentModel[6].setRotationPoint(3F, -1F, 1F);

		attachmentModel[7].addShapeBox(0F, 0F, 0F, 58, 6, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 221
		attachmentModel[7].setRotationPoint(3F, -1F, -4F);

		attachmentModel[8].addShapeBox(0F, 0F, 0F, 58, 4, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 222
		attachmentModel[8].setRotationPoint(3F, 1F, -1F);

		attachmentModel[9].addShapeBox(0F, 0F, 0F, 58, 2, 5, 0F, 0F, 0F, 1.5F, 0F, 0F, 1.5F, 0F, 0F, 1.5F, 0F, 0F, 1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 223
